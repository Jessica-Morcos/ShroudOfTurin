...
function Talks() {
  const cards = [
    ...
    ['https://img.youtube.com/vi/9gwcP5jn9E4/maxresdefault.jpg', "Archangel Raphael & St. Marina Coptic Orthodox Church - June 18th", 'Parish talk · 1 hour 15 min', 'https://youtu.be/9gwcP5jn9E4?si=N_C6vXsvjLiH9P8s'],
  ];
