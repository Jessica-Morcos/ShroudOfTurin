...
const hotspots = [
  ...
  ['4',  '56', '4.0', 'Foot Wound',      'Nail wound through the feet',               'Blood and wound marks at the feet are consistent with crucifixion nailing through the metatarsal bones. In 1968 archaeologists in Jerusalem discovered the ossuary of a crucified man (Yohanan ben Hagkol) with an iron nail still through his heel bone, confirming this method. The left foot appears to have been placed over the right before nailing.'],
  ['35', '22', '3.2', '1532 Fire Damage','Burn marks and the Poor Clare repair patches','The triangular linen patches and parallel scorch lines result from the 1532 fire in Chambéry, France, when molten silver from the reliquary dripped onto the folded cloth. Because the cloth was folded, burns appear in symmetric pairs along its length. Poor Clare nuns repaired the worst holes with patches still visible as lighter rectangles. The damage later complicated carbon-14 sampling.'],
  ...
  ['75', '18', '3.2', 'Poker Holes', 'Sets of small burn holes in an L-shaped pattern.', ' They predate the 1532 fire: a 1516 copy kept in Lier, Belgium reproduces them but not the later fire damage. Theory on the origin are that it was done in a liturgy accidentally with incense. The same L-shaped marks appear on the Pray Codex, a Hungarian manuscript dated to around 1192-1195, which is one of the arguments against the medieval radiocarbon date.'],
